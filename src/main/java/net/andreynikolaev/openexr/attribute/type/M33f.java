 ...
 */
public class M33f implements BaseAttributeType {
    
    private final int COUNT = 0x09;
    private float[] floatArrayValue = new float[COUNT];
    
    public M33f(float[] floatArray) throws OpenExrAttributeException{
        if(floatArray.length != COUNT) throw new OpenExrAttributeException();
        this.floatArrayValue = floatArray;
    }

    public M33f(ByteBuffer byteBuffer) {
